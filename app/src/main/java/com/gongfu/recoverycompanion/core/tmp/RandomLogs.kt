...
internal val previewLogs = listOf(
    ...
    LogEntry(id = 0, timestamp = timeStamp, title = "Skipped workout",
        ...
        bodyResponse = "Restless legs, tight chest, self-loathing", outcome = false
    ),
    LogEntry(id = 0, timestamp = timeStamp, title = "Crushed work project",
        ...
        bodyResponse = "Clear mind, steady energy, confident posture", outcome = true
    ),
    LogEntry(id = 0, timestamp = timeStamp, title = "Avoided phone call",
        ...
        bodyResponse = "Racing heart, sweaty palms, stomach knots", outcome = false
    ),
    LogEntry(id = 0, timestamp = timeStamp, title = "Nailed presentation",
        ...
        bodyResponse = "Light body, strong voice, warm glow", outcome = true
    ),
    LogEntry(id = 0, timestamp = timeStamp, title = "Binge watched Netflix",
        ...
        bodyResponse = "Brain fog, sore eyes, heavy guilt", outcome = false
    ),
    LogEntry(id = 0, timestamp = timeStamp, title = "Finally cleaned kitchen",
        ...
        bodyResponse = "Light shoulders, clear mind", outcome = true
    ),
    LogEntry(id = 0, timestamp = timeStamp, title = "Ghosted friend text",
        ...
        bodyResponse = "Fluttering stomach, tense neck", outcome = false
    ),
    LogEntry(id = 0, timestamp = timeStamp, title = "Meditation breakthrough",
        ...
        bodyResponse = "Deep calm, slow breathing, grounded", outcome = true
    ),
    LogEntry(
        ...
        bodyResponse = "Sweating, shaking hands, nausea", outcome = false
    ),
    // Continue pattern with 40 more...
    LogEntry(id = 0, timestamp = timeStamp, title = "Read 30 pages",
        description = "Got lost in the book. Time flew by. Best escape all week.", trigger = "Curiosity", location = "Couch", intensityLevel = 2, bodyResponse = "Relaxed eyes, steady breath", outcome = true),
    LogEntry(id = 0, timestamp = timeStamp, title = "Avoided grocery shopping",
        description = "Empty fridge but stayed home ordering takeout. Hate myself for it.", trigger = "Decision fatigue", location = "Apartment", intensityLevel = 6, bodyResponse = "Empty stomach tension", outcome = false),
    LogEntry(id = 0, timestamp = timeStamp, title = "Fixed broken lamp",
        description = "Tinkering paid off. Light works perfectly now.", trigger = "Problem solving", location = "Bedroom", intensityLevel = 3, bodyResponse = "Pride swell", outcome = true),
    LogEntry(id = 0, timestamp = timeStamp, title = "Skipped therapy",
        description = "Made excuse about being busy. Avoided dealing with my issues.", trigger = "Fear", location = "Home", intensityLevel = 8, bodyResponse = "Chest tightness", outcome = false),
    LogEntry(id = 0, timestamp = timeStamp, title = "Walked 10k steps",
        description = "Fresh air cleared my head. Neighborhood looks beautiful today.", trigger = "Endorphins", location = "Street", intensityLevel = 1, bodyResponse = "Loose limbs", outcome = true),
    LogEntry(id = 0, timestamp = timeStamp, title = "Fought with roommate",
        description = "Dishes argument escalated. Tense silence now.", trigger = "Passive aggression", location = "Kitchen", intensityLevel = 9, bodyResponse = "Jaw clenched", outcome = false),
    LogEntry(id = 0, timestamp = timeStamp, title = "Finished online course",
        description = "Certificate downloaded. Felt smart for once.", trigger = "Accomplishment", location = "Desk", intensityLevel = 2, bodyResponse = "Warm pride", outcome = true),
    LogEntry(id = 0, timestamp = timeStamp, title = "Ignored work email",
        description = "Boss needs response by tomorrow. Pretending I didn't see it.", trigger = "Overwhelm", location = "Phone", intensityLevel = 7, bodyResponse = "Stomach pit", outcome = false),
    LogEntry(id = 0, timestamp = timeStamp, title = "Cooked healthy dinner",
        description = "Salmon and veggies. Actually enjoyed cooking.", trigger = "Self-care", location = "Kitchen", intensityLevel = 2, bodyResponse = "Satisfied fullness", outcome = true),
    LogEntry(id = 0, timestamp = timeStamp, title = "Stayed up too late",
        description = "Doomscrolling until 2am. Alarm will destroy me.", trigger = "Phone addiction", location = "Bed", intensityLevel = 8, bodyResponse = "Burning eyes", outcome = false)
